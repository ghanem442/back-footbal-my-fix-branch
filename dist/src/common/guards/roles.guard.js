...
let RolesGuard = class RolesGuard {
    constructor(reflector) {
        ...
        this.roleHierarchy = {
            [client_1.Role.PLAYER]: 1,
            [client_1.Role.FIELD_OWNER]: 2,
    ...
    canActivate(context) {
        ...
        if (!hasAccess) {
            throw new common_1.ForbiddenException(`Access denied: ${user.role} role is not authorized to access this resource`);
        }
        return true;
    }
    checkRoleAccess(userRole, requiredRoles) {
